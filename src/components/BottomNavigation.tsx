...
const DATA = {
  ...
  contact: {
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/icmulnk57",
        icon: Icons.github,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/aman-mandal-7bb7491b5/",
        icon: Icons.linkedin,
      },
      Medium: {
        name: "Medium",
        url: "https://medium.com/@mandalamankumar.786",
        icon: Icons.medium,
      },
      leetcode:{
        name: "LeetCode",
        url: "https://leetcode.com/u/martian57/",
        icon: Icons.leetcode,
      }
    },
  },
...
const BottomNavigation = () => {
  return (
    <div className="flex w-full fixed z-[999] bottom-[50px] items-center justify-center">
      <TooltipProvider>
